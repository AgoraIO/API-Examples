...
.\installThirdParty.bat && "C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\MSBuild\Current\Bin\MSBuild.exe" "APIExample.sln" /p:platform="Win32" /p:configuration="Release" && 7z a -tzip result.zip -r Release && copy result.zip %WORKSPACE%\\APIExample-windows.zip
