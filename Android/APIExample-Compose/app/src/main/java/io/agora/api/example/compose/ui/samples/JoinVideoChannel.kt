package io.agora.api.example.compose.ui.samples
...
import io.agora.api.example.compose.ui.common.VideoStatsConfig
...
fun JoinVideoChannel() {
    ...
    val statsMap  = remember { mutableStateMapOf(0 to VideoStatsConfig(id = 0, statsLocal = true)) }
