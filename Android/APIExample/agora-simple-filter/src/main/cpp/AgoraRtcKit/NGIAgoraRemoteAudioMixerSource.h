...
class IRemoteAudioMixerSource : public RefCountInterface {
 public:
   ...
   */
  virtual int addAudioTrack(agora_refptr<IRemoteAudioTrack> track, ahpl_ref_t ares = AHPL_REF_INVALID) = 0;
   ...
   */
  virtual int removeAudioTrack(agora_refptr<IRemoteAudioTrack> track, ahpl_ref_t ares = AHPL_REF_INVALID) = 0;
