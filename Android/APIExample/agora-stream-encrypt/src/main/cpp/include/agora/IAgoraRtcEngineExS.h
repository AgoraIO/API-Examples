...
class IRtcEngineEventHandlerExS : public IRtcEngineEventHandlerS {
 public:
  ...
  using IRtcEngineEventHandlerS::onTranscodedStreamLayoutInfo;
   ...
   *
   * @param connection The RtcConnectionS object.
   * @param elapsed The time elapsed (ms) from the local user calling joinChannel until the SDK triggers this callback.
   */
  virtual void onJoinChannelSuccess(const RtcConnectionS& connection, int elapsed) {
    (void)connection;
    (void)elapsed;
  }
   ...
   */
  virtual void onRejoinChannelSuccess(const RtcConnectionS& connection, int elapsed) {
    (void)connection;
    (void)elapsed;
  }
   ...
   */
  virtual void onAudioVolumeIndication(const RtcConnectionS& connection, const AudioVolumeInfoS* speakers,
   ...
   */
  virtual void onLeaveChannel(const RtcConnectionS& connection, const RtcStats& stats) {
    (void)connection;
    (void)stats;
  }
   ...
   */
  virtual void onRtcStats(const RtcConnectionS& connection, const RtcStats& stats) {
    (void)connection;
    (void)stats;
  }
   ...
   *
   * @param connection The RtcConnectionS object.
   * @param remoteUserAccount The user account. The network quality of the user with this user ID is reported.
   ...
   */
  virtual void onNetworkQuality(const RtcConnectionS& connection, const char* remoteUserAccount, int txQuality, int rxQuality) {
    (void)connection;
   ...
   * @param connection The RtcConnectionS object.
   */
  virtual void onIntraRequestReceived(const RtcConnectionS& connection) {
    (void)connection;
  }
   ...
   * this callback.
  */
  virtual void onFirstLocalVideoFramePublished(const RtcConnectionS& connection, int elapsed) {
    (void)connection;
    (void)elapsed;
  }
  ...
  @param connection The RtcConnectionS object.
  @param remoteUserAccount The user ID of the remote user sending the video stream.
  ...
  */
  virtual void onFirstRemoteVideoDecoded(const RtcConnectionS& connection, const char* remoteUserAccount, int width, int height, int elapsed) {
    (void)connection;
    (void)remoteUserAccount;
    (void)width;
    (void)height;
   ...
   */
  virtual void onVideoSizeChanged(const RtcConnectionS& connection, VIDEO_SOURCE_TYPE sourceType, const char* userAccount, int width, int height, int rotation) {
    (void)connection;
    (void)userAccount;
    (void)width;
    (void)height;
   ...
   */
  virtual void onLocalVideoStateChanged(const RtcConnectionS& connection,
   ...
   *
   * @param connection The RtcConnectionS object.
   * @param remoteUserAccount The ID of the user whose video state has changed.
   ...
   */
  virtual void onRemoteVideoStateChanged(const RtcConnectionS& connection, const char* remoteUserAccount, REMOTE_VIDEO_STATE state, REMOTE_VIDEO_STATE_REASON reason, int elapsed) {
    (void)connection;
    (void)remoteUserAccount;
    (void)state;
    (void)reason;
   ...
   * @param elapsed The time elapsed (ms) from the local user calling `joinChannel` until the SDK triggers this callback.
   */
  virtual void onFirstRemoteVideoFrame(const RtcConnectionS& connection, const char* remoteUserAccount, int width, int height, int elapsed) {
    (void)connection;
    (void)remoteUserAccount;
    (void)width;
    (void)height;
   ...
   *
   * @param connection The RtcConnectionS object.
   * @param remoteUserAccount The ID of the remote user or broadcaster joining the channel.
   * @param elapsed The time elapsed (ms) from the local user calling `joinChannel` or `setClientRole`
   * until this callback is triggered.
  */
  virtual void onUserJoined(const RtcConnectionS& connection, const char* remoteUserAccount, int elapsed) {
    (void)connection;
    (void)remoteUserAccount;
    (void)elapsed;
  }
   ...
   *
   * @param connection The RtcConnectionS object.
   * @param remoteUserAccount The ID of the remote user or broadcaster who leaves the channel or drops offline.
   * @param reason The reason why the remote user goes offline: #USER_OFFLINE_REASON_TYPE.
   */
  virtual void onUserOffline(const RtcConnectionS& connection, const char* remoteUserAccount, USER_OFFLINE_REASON_TYPE reason) {
    (void)connection;
    (void)remoteUserAccount;
    (void)reason;
  }
   ...
   *
   * @param connection The RtcConnectionS object.
   * @param remoteUserAccount The user ID.
   * @param muted Whether the remote user's audio stream is muted/unmuted:
   * - true: Muted.
   * - false: Unmuted.
   */
 virtual void onUserMuteAudio(const RtcConnectionS& connection, const char* remoteUserAccount, bool muted) {
    (void)connection;
    (void)remoteUserAccount;
    (void)muted;
  }
   ...
   *
   * @param connection The RtcConnectionS object.
   * @param remoteUserAccount ID of the remote user.
   ...
   */
 virtual void onUserMuteVideo(const RtcConnectionS& connection, const char* remoteUserAccount, bool muted) {
    (void)connection;
    (void)remoteUserAccount;
    (void)muted;
  }
  ...
  */
  virtual void onUserEnableVideo(const RtcConnectionS& connection, const char* remoteUserAccount, bool enabled) {
    (void)connection;
    (void)remoteUserAccount;
    (void)enabled;
  }
   ...
   */
  virtual void onUserStateChanged(const RtcConnectionS& connection, const char* remoteUserAccount, uint32_t state) {
    (void)connection;
    (void)remoteUserAccount;
    (void)state;
  }
   ...
   * See LocalAudioStats.
   */
  virtual void onLocalAudioStats(const RtcConnectionS& connection, const LocalAudioStats& stats) {
    (void)connection;
    (void)stats;
  }
   ...
   */
  virtual void onRemoteAudioStats(const RtcConnectionS& connection, const RemoteAudioStatsS& stats) {
    (void)connection;
    (void)stats;
  }
   ...
   */
  virtual void onLocalVideoStats(const RtcConnectionS& connection, const LocalVideoStatsS& stats) {
    (void)connection;
    (void)stats;
  }
   ...
   * RemoteVideoStats.
   */
  virtual void onRemoteVideoStats(const RtcConnectionS& connection, const RemoteVideoStatsS& stats) {
    (void)connection;
    (void)stats;
  }
   ...
   * @param connection The RtcConnectionS object.
   */
  virtual void onConnectionLost(const RtcConnectionS& connection) {
    (void)connection;
  }
   ...
   * @param connection The RtcConnectionS object.
   */
  virtual void onConnectionBanned(const RtcConnectionS& connection) {
    (void)connection;
  }
   ...
   *
   * @param connection The RtcConnectionS object.
   * @param remoteUserAccount ID of the user who sends the data stream.
   ...
   */
  virtual void onStreamMessage(const RtcConnectionS& connection, const char* remoteUserAccount, int streamId, const char* data, size_t length, uint64_t sentTs) {
    (void)connection;
    (void)remoteUserAccount;
    (void)streamId;
    (void)data;
   ...
   * interrupted.
   */
  virtual void onStreamMessageError(const RtcConnectionS& connection, const char* remoteUserAccount, int streamId, int code, int missed, int cached) {
    (void)connection;
    (void)remoteUserAccount;
    (void)streamId;
    (void)code;
   ...
   * @param connection The RtcConnectionS object.
   */
  virtual void onRequestToken(const RtcConnectionS& connection) {
    (void)connection;
  }
   ...
   */
  virtual void onLicenseValidationFailure(const RtcConnectionS& connection, LICENSE_ERROR_TYPE reason) {
    (void)connection;
    (void)reason;
  }
   ...
   */
  virtual void onTokenPrivilegeWillExpire(const RtcConnectionS& connection, const char* token) {
    (void)connection;
    (void)token;
  }
   ...
   */
  virtual void onFirstLocalAudioFramePublished(const RtcConnectionS& connection, int elapsed) {
    (void)connection;
    (void)elapsed;
  }
   ...
   */
  virtual void onLocalAudioStateChanged(const RtcConnectionS& connection, LOCAL_AUDIO_STREAM_STATE state, LOCAL_AUDIO_STREAM_ERROR error) {
    (void)connection;
    (void)state;
    (void)error;
  }
   ...
   *
   * @param connection The RtcConnectionS object.
   * @param remoteUserAccount ID of the remote user whose audio state changes.
   ...
   */
  virtual void onRemoteAudioStateChanged(const RtcConnectionS& connection, const char* remoteUserAccount, REMOTE_AUDIO_STATE state, REMOTE_AUDIO_STATE_REASON reason, int elapsed) {
    (void)connection;
    (void)remoteUserAccount;
    (void)state;
    (void)reason;
   ...
   */
  virtual void onActiveSpeaker(const RtcConnectionS& connection, const char* userAccount) {
    (void)connection;
    (void)userAccount;
  }
   ...
   *
   * @param connection The RtcConnectionS of the local user: #RtcConnectionS
   ...
   */
  virtual void onClientRoleChanged(const RtcConnectionS& connection, CLIENT_ROLE_TYPE oldRole, CLIENT_ROLE_TYPE newRole, const ClientRoleOptions& newRoleOptions) {
    (void)connection;
    (void)oldRole;
    (void)newRole;
    (void)newRoleOptions;
   ...
   */
  virtual void onClientRoleChangeFailed(const RtcConnectionS& connection, CLIENT_ROLE_CHANGE_FAILED_REASON reason, CLIENT_ROLE_TYPE currentRole) {
    (void)connection;
    (void)reason;
    (void)currentRole;
  }
   ...
   */
  virtual void onConnectionStateChanged(const RtcConnectionS& connection,
   ...
   */
  virtual void onWlAccMessage(const RtcConnectionS& connection, WLACC_MESSAGE_REASON reason, WLACC_SUGGEST_ACTION action, const char* wlAccMsg) {
    (void)connection;
    (void)reason;
    (void)action;
    (void)wlAccMsg;
   ...
   */
  virtual void onWlAccStats(const RtcConnectionS& connection, WlAccStats currentStats, WlAccStats averageStats) {
    (void)connection;
    (void)currentStats;
    (void)averageStats;
  }
   ...
   */
  virtual void onNetworkTypeChanged(const RtcConnectionS& connection, NETWORK_TYPE type) {
    (void)connection;
    (void)type;
  }
   ...
   */
  virtual void onEncryptionError(const RtcConnectionS& connection, ENCRYPTION_ERROR_TYPE errorType) {
    (void)connection;
    (void)errorType;
  }
  /**
   ...
   */
  virtual void onUploadLogResult(const RtcConnectionS& connection, const char* requestId, bool success, UPLOAD_ERROR_REASON reason) {
    (void)connection;
    (void)requestId;
    (void)success;
    (void)reason;
   ...
   */
  virtual void onSnapshotTaken(const RtcConnectionS& connection, const char* userAccount, const char* filePath, int width, int height, int errCode) {
    (void)userAccount;
    (void)filePath;
    (void)width;
    (void)height;
   ...
   */
  virtual void onVideoRenderingTracingResult(const RtcConnectionS& connection, const char* userAccount, MEDIA_TRACE_EVENT currentEvent, VideoRenderingTracingInfo tracingInfo) {
    (void)userAccount;
    (void)currentEvent;
    (void)tracingInfo;
  }
   ...
   * @param code The error code:
   */
  virtual void onSetRtmFlagResult(const RtcConnectionS& connection, int code) {
    (void)code;
  }
  /**
   ...
   */
  virtual void onTranscodedStreamLayoutInfo(const RtcConnectionS& connection, user_id_t userId, int width, int height, int layoutCount,const VideoLayout* layoutlist) {
    (void)userId;
    (void)width;
    (void)height;
    (void)layoutCount;
...
public:
    ...
    * @param eventHandler The event handler: IRtcEngineEventHandlerS.
    *
    * @return
    * - 0: Success.
    * - < 0: Failure.
    ...
    */
    virtual int joinChannelEx(const char* token, const RtcConnectionS& connection,
                              const ChannelMediaOptions& options,
                              IRtcEngineEventHandlerS* eventHandler) = 0;
   ...
   * SDK triggers the \ref IRtcEngineEventHandlerS::onLeaveChannel "onLeaveChannel" callback.
   *
   * @param connection The RtcConnectionS object.
   * @return
   * - 0: Success.
   * - < 0: Failure.
   */
    virtual int leaveChannelEx(const RtcConnectionS& connection) = 0;
     ...
     * - < 0: Failure.
     */
    virtual int leaveChannelEx(const RtcConnectionS& connection, const LeaveChannelOptions& options) = 0;
     ...
     * - < 0: Failure.
     */
    virtual int updateChannelMediaOptionsEx(const ChannelMediaOptions& options, const RtcConnectionS& connection) = 0;
    /**
     ...
     * - < 0: Failure.
     */
    virtual int setVideoEncoderConfigurationEx(const VideoEncoderConfiguration& config, const RtcConnectionS& connection) = 0;
    /**
     ...
     * - < 0: Failure.
     */
    virtual int setupRemoteVideoEx(const VideoCanvasS& canvas, const RtcConnectionS& connection) = 0;
    /**
     ...
     * - < 0: Failure.
     */
    virtual int muteRemoteAudioStreamEx(const char* userAccount, bool mute, const RtcConnectionS& connection) = 0;
    /**
     ...
     * @param connection The RtcConnetionS object.
     *
     * @return
     * - 0: Success.
     * - < 0: Failure.
     */
    virtual int muteRemoteVideoStreamEx(const char* userAccount, bool mute, const RtcConnectionS& connection) = 0;
    /**
     ...
     * - < 0: Failure.
     */
    virtual int setRemoteVideoStreamTypeEx(const char* userAccount, VIDEO_STREAM_TYPE streamType, const RtcConnectionS& connection) = 0;
    /**
     ...
     *- < 0: Failure.
     */
    virtual int muteLocalAudioStreamEx(bool mute, const RtcConnectionS& connection) = 0;
     ...
     *- < 0: Failure.
     */
    virtual int muteLocalVideoStreamEx(bool mute, const RtcConnectionS& connection) = 0;
     ...
     *- < 0: Failure.
     */
    virtual int muteAllRemoteAudioStreamsEx(bool mute, const RtcConnectionS& connection) = 0;
     ...
     *- < 0: Failure.
     */
    virtual int muteAllRemoteVideoStreamsEx(bool mute, const RtcConnectionS& connection) = 0;
     ...
     * - < 0: Failure.
     */
    virtual int setSubscribeAudioBlocklistEx(const char** userAccountList, int userAccountNumber, const RtcConnectionS& connection) = 0;
     ...
     * - < 0: Failure.
     */
    virtual int setSubscribeAudioAllowlistEx(const char** userAccountList, int userAccountNumber, const RtcConnectionS& connection) = 0;
     ...
     * - < 0: Failure.
     */
    virtual int setSubscribeVideoBlocklistEx(const char** userAccountList, int userAccountNumber, const RtcConnectionS& connection) = 0;
     ...
     * - < 0: Failure.
     */
    virtual int setSubscribeVideoAllowlistEx(const char** userAccountList, int userAccountNumber, const RtcConnectionS& connection) = 0;
    /**
     ...
     * - < 0: Failure.
     */
    virtual int setRemoteVideoSubscriptionOptionsEx(const char* userAccount, const VideoSubscriptionOptions& options, const RtcConnectionS& connection) = 0;
    ...
    - < 0: Failure.
    */
    virtual int setRemoteVoicePositionEx(const char* userAccount, double pan, double gain, const RtcConnectionS& connection) = 0;
    ...
    - < 0: Failure.
    */
    virtual int setRemoteUserSpatialAudioParamsEx(const char* userAccount, const agora::SpatialAudioParams& params, const RtcConnectionS& connection) = 0;
    /**
    ...
    virtual int setRemoteRenderModeEx(const char* userAccount, media::base::RENDER_MODE_TYPE renderMode,
                                      VIDEO_MIRROR_MODE_TYPE mirrorMode, const RtcConnectionS& connection) = 0;
     ...
     * - < 0: Failure.
     */
    virtual int enableLoopbackRecordingEx(const RtcConnectionS& connection, bool enabled, const char* deviceName = NULL) = 0;
     ...
     * - < 0: Failure.
     */
    virtual int adjustRecordingSignalVolumeEx(int volume, const RtcConnectionS& connection) = 0;
     ...
     * - < 0: Failure.
     */
    virtual int muteRecordingSignalEx(bool mute, const RtcConnectionS& connection) = 0;
     ...
     * - < 0: Failure.
     */    
    virtual int adjustUserPlaybackSignalVolumeEx(const char* userAccount, int volume, const RtcConnectionS& connection) = 0;

    /** Gets the current connection state of the SDK.
     @param connection The RtcConnectionS object.
     @return #CONNECTION_STATE_TYPE.
     */
    virtual CONNECTION_STATE_TYPE getConnectionStateEx(const RtcConnectionS& connection) = 0;
     ...
     */
    virtual int enableEncryptionEx(const RtcConnectionS& connection, bool enabled, const EncryptionConfig& config) = 0;
     ...
     * - < 0: Failure.
     */
    virtual int createDataStreamEx(int* streamId, bool reliable, bool ordered, const RtcConnectionS& connection) = 0;
    /** Creates a data stream.
     *
     ...
     * - < 0: Failure.
     */
    virtual int createDataStreamEx(int* streamId, const DataStreamConfig& config, const RtcConnectionS& connection) = 0;
    /** Sends a data stream.
     *
     ...
     * \ref IRtcEngineEventHandlerS::onStreamMessage "onStreamMessage" callback on
     * the remote client. After the remote user does not receive the data stream within 5 seconds,
     * the SDK triggers the \ref IRtcEngineEventHandlerS::onStreamMessageError "onStreamMessageError"
     ...
     * - < 0: Failure.
     */
    virtual int sendStreamMessageEx(int streamId, const char* data, size_t length, const RtcConnectionS& connection) = 0;
    ...
    - < 0: Failure.
    */
    virtual int addVideoWatermarkEx(const char* watermarkUrl, const WatermarkOptions& options, const RtcConnectionS& connection) = 0;
    ...
    - < 0: Failure.
    */
    virtual int clearVideoWatermarkEx(const RtcConnectionS& connection) = 0;
    ...
    virtual int sendCustomReportMessageEx(const char* id, const char* category, const char* event, const char* label,
                                          int value, const RtcConnectionS& connection) = 0;

    /**
     * Enables the `onAudioVolumeIndication` callback to report on which users are speaking
     * and the speakers' volume.
     *
     * Once the \ref IRtcEngineEventHandlerS::onAudioVolumeIndication "onAudioVolumeIndication"
     ...
     * - < 0: Failure.
     */
    virtual int enableAudioVolumeIndicationEx(int interval, int smooth, bool reportVad, const RtcConnectionS& connection) = 0;
    ...
    /** Publishes the local stream without transcoding to a specified CDN live RTMP address.  (CDN live only.)
      ...
      * @param connection RtcConnectionS.
      *
      * @return
      * - 0: Success.
      * - < 0: Failure.
      */
    virtual int startRtmpStreamWithoutTranscodingEx(const char* url, const RtcConnectionS& connection) = 0;
    ...
    /** Publishes the local stream with transcoding to a specified CDN live RTMP address.  (CDN live only.)
      ...
      * - < 0: Failure.
      */
    virtual int startRtmpStreamWithTranscodingEx(const char* url, const LiveTranscodingS& transcoding, const RtcConnectionS& connection) = 0;
    ...
    /** Update the video layout and audio settings for CDN live. (CDN live only.)
      ...
      * - < 0: Failure.
      */
    virtual int updateRtmpTranscodingEx(const LiveTranscodingS& transcoding, const RtcConnectionS& connection) = 0;
    ...
    /** Stop an RTMP stream with transcoding or without transcoding from the CDN. (CDN live only.)
      ...
      * - < 0: Failure.
      */
    virtual int stopRtmpStreamEx(const char* url, const RtcConnectionS& connection) = 0;
     ...
     */
    virtual int startOrUpdateChannelMediaRelayEx(const ChannelMediaRelayConfigurationS& configuration, const RtcConnectionS& connection) = 0;
     ...
     */
    virtual int stopChannelMediaRelayEx(const RtcConnectionS& connection) = 0;
     ...
     *   - -7(ERR_NOT_INITIALIZED): cross channel media streams are not relayed.
     */
    virtual int pauseAllChannelMediaRelayEx(const RtcConnectionS& connection) = 0;
     ...
     *   - -7(ERR_NOT_INITIALIZED): cross channel media streams are not relayed.
     */
    virtual int resumeAllChannelMediaRelayEx(const RtcConnectionS& connection) = 0;
    ...
    virtual int enableDualStreamModeEx(bool enabled, const SimulcastStreamConfig& streamConfig,
                                       const RtcConnectionS& connection) = 0;
    /**
  ...
  /**
    ...
    * - <0 : Failure.
    */
    virtual int setHighPriorityUserListEx(const char** userAccountList, int userAccountNum,
   ...
   * - < 0 : Failure.
   */
    virtual int takeSnapshotEx(const RtcConnectionS& connection, const char* userAccount, const char* filePath)  = 0;
    ...
    /**
     ...
     - The tracing result can be obtained through callback `IRtcEngineEventHandlerS(Ex)::onVideoRenderingTracingResult`
     @param connection The RtcConnectionS object.
     @note
     ...
     - 0: Success.
     - < 0: Failure.
      - -2(ERR_INVALID_ARGUMENT): The parameter is invalid. Check the channel ID and local userAccount set by parameter `connection`.
      - -7(ERR_NOT_INITIALIZED): The SDK is not initialized. Initialize the `IRtcEngine` instance before calling this method.
     */
    virtual int startMediaRenderingTracingEx(const RtcConnectionS& connection) = 0;

    /** Provides the technical preview functionalities or special customizations by configuring the SDK with JSON options.
    @since v4.3.0
    @param connection The connection information. See RtcConnectionS.
    @param parameters Pointer to the set parameters in a JSON string.
    @return
    - 0: Success.
    - < 0: Failure.
    */
    virtual int setParametersEx(const RtcConnectionS& connection, const char* parameters) = 0;
};
