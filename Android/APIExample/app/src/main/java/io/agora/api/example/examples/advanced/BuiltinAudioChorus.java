...
@Example(
    index = 30,
    group = ADVANCED,
    name = R.string.item_builtin_audio_chorus,
    actionId = R.id.action_mainFragment_to_joinChannelAudio,
    tipsId = R.string.joinchannelaudio
)
public class BuiltinAudioChorus extends BaseFragment implements View.OnClickListener
{
  private static final String TAG = BuiltinAudioChorus.class.getSimpleName();
