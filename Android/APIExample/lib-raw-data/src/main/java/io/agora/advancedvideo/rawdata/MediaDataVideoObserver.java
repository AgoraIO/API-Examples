...
public interface MediaDataVideoObserver {
    ...
    void onMediaplayerVideoFrame(byte[] data, int frameType, int width, int height, int bufferLength, int yStride, int uStride, int vStride, int rotation, long renderTimeMs, int mediaPlayerId);
