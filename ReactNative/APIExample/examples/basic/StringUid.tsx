...
import { View, TextInput, PermissionsAndroid, StyleSheet, Button, Platform, Alert } from 'react-native';
...
export default class StringUid extends Component<{}, State, any> {
    ...
    _joinChannel = async () => {
        ...
        await this._engine?.joinChannelWithUserAccount(config.token, channelId, stringUid);
    }
    ...
    _getUserInfo = () => {
        ...
        this._engine?.getUserInfoByUserAccount(stringUid).then((userInfo) => {
