...
class GlobalSettings {
    ...
    // For the regions that Agora supports, see https://api-ref.agora.io/en/voice-sdk/ios/4.x/documentation/agorartckit/agoraareacodetype. After specifying the region, the SDK connects to the Agora servers within that region.
