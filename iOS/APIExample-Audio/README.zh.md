...
本项目提供一组 Agora RTC 音频 API 示例，帮助你了解各项 API 的使用方式。
...
确认 `APIExample-Audio.xcworkspace` 已成功生成。

### 获取 App ID

1. 登录 [Agora Console](https://console.agora.io/) 并创建项目。
2. 在项目详情页复制 App ID。
3. 使用 Xcode 打开 `APIExample-Audio.xcworkspace`。
4. 编辑 `APIExample-Audio/Common/KeyCenter.swift`，填入 App ID：
