...
#import "CustomVideoRender.h"
#import "KeyCenter.h"
#import <AgoraRtcKit/AgoraRtcKit.h>
#import "VideoView.h"
#import "APIExample_OC-swift.h"

@interface CustomVideoRenderEntry ()
@property (weak, nonatomic) IBOutlet UITextField *textField;

@end

@implementation CustomVideoRenderEntry
...
- (IBAction)onClickJoinButton:(id)sender {
    ...
    UIStoryboard *storyBoard = [UIStoryboard storyboardWithName:@"CustomVideoRender" bundle:nil];
    BaseViewController *newViewController = [storyBoard instantiateViewControllerWithIdentifier:@"CustomVideoRender"];
...
@interface CustomVideoRender ()<AgoraRtcEngineDelegate>
@property (weak, nonatomic) IBOutlet UIView *containerView;
@property (nonatomic, strong)VideoView *localView;
@property (nonatomic, strong)MetalVideoView *remoteView;
...
- (MetalVideoView *)remoteView {
    if (_remoteView == nil) {
        _remoteView = (MetalVideoView *)[NSBundle loadViewFormNib:@"VideoViewMetal"];
    }
    return _remoteView;
}
...
- (void)viewDidLoad {
    ...
    [self.agoraKit setVideoFrameDelegate:self.remoteView.videoView];
...
- (void)rtcEngine:(AgoraRtcEngineKit *)engine didJoinedOfUid:(NSUInteger)uid elapsed:(NSInteger)elapsed {
    ...
    [self.remoteView.videoView startRenderWithUid:uid];
...
- (void)rtcEngine:(AgoraRtcEngineKit *)engine didOfflineOfUid:(NSUInteger)uid reason:(AgoraUserOfflineReason)reason {
    ...
    [self.remoteView.videoView stopRenderWithUid:uid];
}
