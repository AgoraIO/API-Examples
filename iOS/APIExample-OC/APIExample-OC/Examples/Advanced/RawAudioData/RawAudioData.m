...
#import "RawAudioData.h"
#import "KeyCenter.h"
#import <AgoraRtcKit/AgoraRtcKit.h>
#import "VideoView.h"
#import "APIExample_OC-swift.h"

@interface RawAudioDataEntry ()
@property (weak, nonatomic) IBOutlet UITextField *textField;

@end

@implementation RawAudioDataEntry
...
- (IBAction)onClickJoinButton:(id)sender {
    ...
    UIStoryboard *storyBoard = [UIStoryboard storyboardWithName:@"RawAudioData" bundle:nil];
    BaseViewController *newViewController = [storyBoard instantiateViewControllerWithIdentifier:@"RawAudioData"];
...
@interface RawAudioData ()<AgoraRtcEngineDelegate, AgoraAudioFrameDelegate>
...
- (AgoraAudioFramePosition)getObservedAudioFramePosition {
    return AgoraAudioFramePositionMixed;
}
