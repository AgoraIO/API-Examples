...
#import "JoinChannelAudio.h"
#import "KeyCenter.h"
#import <AgoraRtcKit/AgoraRtcKit.h>
#import "VideoView.h"
#import "APIExample_OC-swift.h"

@interface JoinChannelAudioEntry ()
@property (weak, nonatomic) IBOutlet UITextField *textField;

@end

@implementation JoinChannelAudioEntry
...
- (IBAction)onClickJoinButton:(id)sender {
    ...
    UIStoryboard *storyBoard = [UIStoryboard storyboardWithName:@"JoinChannelAudio" bundle:nil];
    BaseViewController *newViewController = [storyBoard instantiateViewControllerWithIdentifier:@"JoinChannelAudio"];
...
@interface JoinChannelAudio ()<AgoraRtcEngineDelegate>
...
@implementation JoinChannelAudio
