...
#import "JoinChannelVideo.h"
#import "KeyCenter.h"
#import <AgoraRtcKit/AgoraRtcKit.h>
#import "VideoView.h"
#import "APIExample_OC-swift.h"

@interface JoinChannelVideoEntry ()
@property (weak, nonatomic) IBOutlet UITextField *textField;

@end

@implementation JoinChannelVideoEntry
...
- (IBAction)onClickJoinButton:(id)sender {
    ...
    UIStoryboard *storyBoard = [UIStoryboard storyboardWithName:@"JoinChannelVideo" bundle:nil];
    BaseViewController *newViewController = [storyBoard instantiateViewControllerWithIdentifier:@"JoinChannelVideo"];
...
@interface JoinChannelVideo ()<AgoraRtcEngineDelegate>
...
@implementation JoinChannelVideo
