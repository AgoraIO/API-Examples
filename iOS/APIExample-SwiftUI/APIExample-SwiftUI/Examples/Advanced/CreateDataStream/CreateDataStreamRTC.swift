...
class CreateDataStreamRTC: NSObject, ObservableObject {
   ...
   private func setupCanvasView(view: UIView?) {
    ...
    func onSendPress(message: String) {
        ...
        if result != 0 {
            ...
            LogUtils.log(message: message, level: .error)
...
extension CreateDataStreamRTC: AgoraRtcEngineDelegate {
    func rtcEngine(_ engine: AgoraRtcEngineKit, receiveStreamMessageFromUid uid: UInt, streamId: Int, data: Data) {
        ...
        alertMessage = "from: \(uid) message: \(message)"
        isShowAlert = true
    }
    ...
    func rtcEngine(_ engine: AgoraRtcEngineKit,
        ...
        alertMessage = "didOccurStreamMessageErrorFromUid: \(uid)"
        isShowAlert = true
    }
