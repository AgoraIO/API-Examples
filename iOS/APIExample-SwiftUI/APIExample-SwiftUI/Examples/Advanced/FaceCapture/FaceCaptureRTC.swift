...
class FaceCaptureRTC: NSObject, ObservableObject {
    private var agoraKit: AgoraRtcEngineKit!
    private var isJoined: Bool = false
    private var localView: VideoUIView?
    
    @Published var isFaceLicenseEmpty: Bool = false
    ...
    func setupRTC(configs: [String: Any],
        ...
        isFaceLicenseEmpty = (KeyCenter.FaceCaptureLicense ?? "").isEmpty
        guard !isFaceLicenseEmpty else { return }
        // enable face capture
...
extension FaceCaptureRTC: AgoraFaceInfoDelegate {
    func onFaceInfo(_ outFaceInfo: String) -> Bool {
        localView?.statsInfo?.updateMetaInfo(data: outFaceInfo)
        return true
    }
}

extension FaceCaptureRTC: AgoraVideoFrameDelegate {
...
extension FaceCaptureRTC: AgoraRtcEngineDelegate {
