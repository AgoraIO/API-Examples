...
class RhythmPlayerRTC: NSObject, ObservableObject {
    private var agoraKit: AgoraRtcEngineKit!
    private var isJoined: Bool = false
    
    private var localView: VideoUIView?
    private var remoteView: VideoUIView?
    private var config: AgoraRhythmPlayerConfig = AgoraRhythmPlayerConfig()
    
    @Published var isEnabelBeatsMinute: Bool = false
    @Published var isEnabelBeatsMeasure: Bool = false
    ...
    func onPlay() {
        ...
        isEnabelBeatsMinute = true
        isEnabelBeatsMeasure = true
    }
    
    func onStop() {
        agoraKit.stopRhythmPlayer()
        isEnabelBeatsMinute = false
        isEnabelBeatsMeasure = false
    }
    
    func onChangeBeatsMinute(_ value: Float) {
        config.beatsPerMinute = Int32(value)
    }
    
    func onChangeBeatsMeasure(_ value: Float) {
        config.beatsPerMeasure = Int32(value)
    }
...
extension RhythmPlayerRTC: AgoraRtcEngineDelegate {
