...
//    [self.rtcEngineKit setParameters: @"{\"che.video.enable_performance_adaptive_config\":{\"enable_pre_process_fallback_capture\":true}}"];
//    [self.rtcEngineKit setParameters: @"{\"che.video.qoe_diagnose_observer_config\":{\"enable\":true,\"interval_ms\":20000}}"];
//    [self.rtcEngineKit setParameters: @"{\"che.video.capture_aa_config\":{\"enable\":true,\"force_fallback_type\":0}}"];
//    [self.rtcEngineKit setParameters: @"{\"rtc.video.enable_regulator_scale\":true}"];
    [self.rtcEngineKit setParameters @"{\"che.video.enable_performance_adaptive_config\":{\"enable_pre_process_fallback_capture\":true}}" ];
    [self.rtcEngineKit setParameters @"{\"che.video.qoe_diagnose_observer_config\":{\"enable\":true, \"drop_fps\":1, \"interval_ms\":20000}}"];
    [self.rtcEngineKit setParameters @"{\"che.video.capture_aa_config\":{\"enable\":true,\"force_fallback_type\":0}}"];
    [self.rtcEngineKit setParameters @"{\"rtc.video.enable_regulator_scale\":true}"];
    ...
    AgoraVideoEncoderConfiguration *encodeConfig = [[AgoraVideoEncoderConfiguration alloc] initWithSize:CGSizeMake(1080, 1920)
