...
class RawMediaData: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        let videoType:ObserverVideoType = ObserverVideoType(rawValue: ObserverVideoType.captureVideo.rawValue | ObserverVideoType.renderVideo.rawValue | ObserverVideoType.willPreEncodeVideo.rawValue)
