...
- [macOS API Reference (English)](https://api-ref.agora.io/en/video-sdk/macos/4.x/documentation/agorartckit)
- [macOS API Reference (Chinese)](https://doc.shengwang.cn/api-ref/rtc/macos/API/toc_video_call)
