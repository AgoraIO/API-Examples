...
class GlobalSettings {
    ...
    // For the regions that Agora supports, see https://api-ref.agora.io/en/video-sdk/macos/4.x/documentation/agorartckit/agoraareacodetype. After specifying the region, the SDK connects to the Agora servers within that region.
