...
class CBeautyEventHandler2 : public agora::rtc::IRtcEngineEventHandler
{
public:
...
class CDlgBeauty2 : public CDialogEx
{
	DECLARE_DYNAMIC(CDlgBeauty2)

public:
	CDlgBeauty2(CWnd* pParent = nullptr);   // 
	virtual ~CDlgBeauty2();
