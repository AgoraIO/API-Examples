...
public:
	...
	static const int VIDOE_COUNT = 1;
	...
	int StartMultiVideoSource();
	void StopMultiVideoSource();
	void StartShare();
	void StopShare();
private:
	...
	CScreenShareEventHandler screenVidoeSourceEventHandler;
