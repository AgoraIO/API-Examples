...
BOOL CAgoraRegionConnDlg::OnInitDialog()
{
	...
	m_cmbAreaCode.InsertString(nIndex++, _T("AREA_CODE_EU"));
	m_cmbAreaCode.InsertString(nIndex++, _T("AREA_CODE_AS"));
	m_cmbAreaCode.InsertString(nIndex++, _T("AREA_CODE_JP"));
	m_cmbAreaCode.InsertString(nIndex++, _T("AREA_CODE_IN"));
	...
	m_mapAreaCode.insert(std::make_pair(_T("AREA_CODE_EU"), AREA_CODE_EU));
	m_mapAreaCode.insert(std::make_pair(_T("AREA_CODE_AS"), AREA_CODE_AS));
	m_mapAreaCode.insert(std::make_pair(_T("AREA_CODE_JP"), AREA_CODE_JP));
	m_mapAreaCode.insert(std::make_pair(_T("AREA_CODE_IN"), AREA_CODE_IN));
