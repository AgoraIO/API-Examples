...
$agora_sdk = 'https://download.agora.io/sdk/release/Agora_Native_SDK_for_Windows_x86_rel.v3.7.202_57225_20220210_1259_full.zip'
$agora_des = 'Agora_Native_SDK_for_Windows_x86_rel.v3.7.202_57225_20220210_1259_full.zip'
...
if (-not (Test-Path sdk)){
	...
	Move-Item Agora_Native_SDK_for_Windows_x86_rel.v3.7.202_57225_20220210_1259_full\rtc\sdk\*  sdk
	Remove-Item  $agora_des -Recurse
	Remove-Item  Agora_Native_SDK_for_Windows_x86_rel.v3.7.202_57225_20220210_1259_full -Recurse
}
